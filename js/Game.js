class Game {
  ...
  start() {
    ...
    car1.scale = 0.07;
    //Añadir imagen de la explosion car1
    

    car2 = createSprite(width / 2 + 100, height - 100);
    car2.addImage("car2", car2_img);
    car2.scale = 0.07;
    //Añadir imagen de la explosion car2
  ...
  //activar el control del jugador solo si la explosion es falsa
